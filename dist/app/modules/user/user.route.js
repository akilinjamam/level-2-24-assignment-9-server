...
router.post("/reset-password", (0, auth_1.default)(), (0, validateRequest_1.validateRequest)(user_validation_1.userSchema.createResetPasswordValidationSchema), user_controller_1.userController.resetPasswordController);
